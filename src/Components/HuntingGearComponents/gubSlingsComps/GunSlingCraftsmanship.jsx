...
import craftImg from "../../../assets/Images/sling_craftsmanship_detail.jpg";

const GunSlingCraftsmanship = () => {
  const stats = [
    {
      icon: ShieldCheck,
      stat: "100%",
      label: "Full Grain Leather",
      desc: "Vegetable-tanned harness leather hand-cut for superior strength and balanced weight support.",
    },
    {
      icon: Sparkles,
      stat: "Hand",
      label: "Finished",
      desc: "Stitched with thick waxed thread, brass Chicago screws, and hand-burnished edges.",
    },
    {
      icon: Award,
      stat: "Lifetime",
      label: "Craftsmanship",
      desc: "Guaranteed against hardware or stitching failure under field conditions for life.",
    },
  ];
    ...
    <section className="w-full bg-[#F6F2EC] py-16 sm:py-20 lg:py-28 px-6 lg:px-12 xl:px-16 my-12 border-y border-[#E5D8C8]">
      <div className="max-w-[1600px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          {/* LEFT: Close-up leather gun sling craftsmanship image */}
          <motion.div
          ...
          >
            <div className="relative overflow-hidden rounded-[28px] border border-[#E5D8C8] shadow-lg group">
              <img
                src={craftImg}
                alt="Artisan Leather Gun Sling Stitching and Hardware Assembly"
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-[#FAF8F5]/95 backdrop-blur-md p-4 sm:p-5 rounded-2xl border border-[#E5D8C8] shadow-sm">
                <p className="font-serif italic text-[#3B2618] text-sm sm:text-base leading-snug">
                  "A fine gun sling should carry the rifle's weight so quietly you forget it is there."
                </p>
          ...
          {/* RIGHT: Editorial Content & Three Stats */}
          <motion.div
            initial={{ opacity: 0, x: 25 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <p className="text-[#6B6258] text-base sm:text-lg font-normal leading-relaxed mb-8 sm:mb-10">
              Every gun sling is hand-cut and stitched using premium vegetable-tanned leather, combining exceptional durability with timeless elegance for every journey.
            </p>
...
export default GunSlingCraftsmanship;
