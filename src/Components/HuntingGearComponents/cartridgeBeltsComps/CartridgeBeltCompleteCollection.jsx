...
import { cartridgeBeltCollectionItems } from "../../../Data/productsData";

const CartridgeBeltCompleteCollection = ({ onQuickAdd }) => {
  return (
      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="text-center max-w-[700px] mx-auto mb-12 sm:mb-16">
          ...
          <p className="text-[#6B6258] text-base sm:text-lg font-normal leading-relaxed">
            Pair your cartridge belt with matching full-grain leather gear crafted to standard field specifications.
          </p>
        </div>

        {/* 3 Related Products Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-14">
          {cartridgeBeltCollectionItems.map((item, index) => (
            <motion.div
              key={item.id}
...
export default CartridgeBeltCompleteCollection;
