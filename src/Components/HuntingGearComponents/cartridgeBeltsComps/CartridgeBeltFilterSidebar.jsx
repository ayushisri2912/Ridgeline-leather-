...
const CartridgeBeltFilterSidebar = ({
  selectedCategories,
  onCategoryChange,
  priceRange,
  onPriceChange,
  ...
  const sizes = ["32", "34", "36", "38", "40", "42", "Medium", "Large", "XL"];
            ...
            {sizes.map((size) => {
              ...
              return (
                <button
                  ...
                  className={`w-9 h-9 rounded-xl text-xs font-semibold flex items-center justify-center transition-all border cursor-pointer ${
                    isChecked
                      ? "bg-[#3B2618] text-[#FAF8F5] border-[#3B2618]"
                      : "bg-[#FFFDFC] text-[#6B6258] border-[#E5D8C8] hover:border-[#8B5A2B] hover:text-[#3B2618]"
                  }`}
                >
                  {size}
                </button>
        ...
        {openSections.price && (
          <div className="space-y-4 pl-1">
            ...
            <div className="flex justify-between gap-2">
              {[
                { label: "All Prices", val: [150, 300] },
                { label: "< $200", val: [150, 200] },
                { label: "$200+", val: [200, 300] },
              ].map((btn) => (
                <button
                  key={btn.label}
...
export default CartridgeBeltFilterSidebar;
