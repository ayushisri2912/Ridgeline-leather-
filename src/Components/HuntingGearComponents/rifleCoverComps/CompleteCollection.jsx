...
import { complementaryCollection } from "../../../Data/productsData";

const CompleteCollection = ({ onQuickAdd }) => {
  return (
      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="text-center max-w-[700px] mx-auto mb-12 sm:mb-16">
          ...
          <p className="text-[#6B6258] text-base sm:text-lg font-normal leading-relaxed">
            Elevate your field outfit with matching full-grain leather accessories handcrafted from the same rich hides.
          </p>
        </div>

        {/* 3 Related Products Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-14">
          {complementaryCollection.map((item, index) => (
            <motion.div
              key={item.id}
