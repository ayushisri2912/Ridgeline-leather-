  ...
  return (
    <section className="w-full bg-[#FAF8F5] py-16 sm:py-20 lg:py-24 px-6 border-b border-[#E5D8C8]/60">
      <div className="max-w-[700px] mx-auto text-center flex flex-col items-center">
        ...
        >
          Protection Meets Timeless Design
        </motion.h2>
        ...
        >
          Every Ridgeline rifle cover is individually built from thick, vegetable-tanned full-grain leather. Crafted by master artisans with reinforced saddle stitching, brass rivets, and dense protective lining, each piece ages gracefully, gaining character through every field expedition and seasonal hunt.
        </motion.p>
      </div>
    </section>
  );
