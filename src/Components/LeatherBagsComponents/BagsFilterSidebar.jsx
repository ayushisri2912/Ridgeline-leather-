...
const BagsFilterSidebar = ({
  ...
  const collections = ["Travel Series", "Executive Series"];
        ...
        {openSections.price && (
          <div className="space-y-4 pl-1">
            ...
            <div className="flex justify-between gap-2">
              {[
                { label: "All Prices", val: [200, 500] },
                { label: "< $350", val: [200, 350] },
                { label: "$350+", val: [350, 500] },
              ].map((btn) => (
                <button
                  key={btn.label}
...
export default BagsFilterSidebar;
