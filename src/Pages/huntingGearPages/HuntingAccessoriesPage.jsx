...
import AccessoriesHero from "../../Components/HuntingGearComponents/huntingAccessoriesComps/AccessoriesHero";
import AccessoriesIntro from "../../Components/HuntingGearComponents/huntingAccessoriesComps/AccessoriesIntro";
import AccessoriesToolbar from "../../Components/HuntingGearComponents/huntingAccessoriesComps/AccessoriesToolbar";
import AccessoriesFilterSidebar from "../../Components/HuntingGearComponents/huntingAccessoriesComps/AccessoriesFilterSidebar";
import AccessoriesProductCard from "../../Components/HuntingGearComponents/huntingAccessoriesComps/AccessoriesProductCard";
import AccessoriesCraftsmanship from "../../Components/HuntingGearComponents/huntingAccessoriesComps/AccessoriesCraftsmanship";
import FeaturedCollectionBanner from "../../Components/HuntingGearComponents/huntingAccessoriesComps/FeaturedCollectionBanner";
import { huntingAccessoriesProducts } from "../../Data/productsData";

const HuntingAccessoriesPage = () => {
  ...
  const handleCollectionChange = (collection) => {
    setSelectedCollections((prev) =>
      prev.includes(collection)
        ? prev.filter((col) => col !== collection)
        : [...prev, collection]
    );
  };
  ...
  const filteredProducts = useMemo(() => {
    let result = [...huntingAccessoriesProducts];
  ...
  return (
    <div className="bg-[#FAF8F5] min-h-screen text-[#3B2618] selection:bg-[#8B5A2B] selection:text-[#FAF8F5]">
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="bg-[#FFFDFC] border border-[#E5D8C8] rounded-2xl p-12 text-center my-6 flex flex-col items-center">
                ...
                <h3 className="font-serif text-2xl text-[#3B2618] font-normal mb-2">
                  No Accessories Match Selected Filters
                </h3>
                <p className="text-[#6B6258] text-sm max-w-md mb-6">
                  Try adjusting your price range, collection preference, or category filters to explore all items.
                </p>
                <button
      ...
      {/* SECTION 5: HERITAGE CRAFTSMANSHIP */}
      <AccessoriesCraftsmanship />

      {/* SECTION 6: FEATURED COLLECTION BANNER */}
      <FeaturedCollectionBanner onQuickAdd={handleQuickAdd} />
...
export default HuntingAccessoriesPage;
