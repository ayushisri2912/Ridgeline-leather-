...
import OffsetHero from "../../Components/LeatherBagsComponents/OffsetHero";
import FeaturedBagsCollections from "../../Components/LeatherBagsComponents/FeaturedBagsCollections";
import BagsToolbar from "../../Components/LeatherBagsComponents/BagsToolbar";
import BagsFilterSidebar from "../../Components/LeatherBagsComponents/BagsFilterSidebar";
import BagProductCard from "../../Components/LeatherBagsComponents/BagProductCard";
import LifestyleBanner from "../../Components/LeatherBagsComponents/LifestyleBanner";
import RelatedBagsCollections from "../../Components/LeatherBagsComponents/RelatedBagsCollections";
import { leatherBagProducts } from "../../Data/productsData";
import deskHeroImg from "../../assets/Images/shop.avif";
import duffelHeroImg from "../../assets/Images/baggs.jpg";

const LeatherBagsPage = ({ categoryType }) => {
  ...
  if (isMessenger) {
    ...
    heroDescription =
      "Designed for modern professionals, our handcrafted messenger bags combine timeless craftsmanship with everyday functionality and refined elegance.";
  ...
  return (
    <div className="bg-[#FAF8F5] min-h-screen text-[#3B2618] selection:bg-[#8B5A2B] selection:text-[#FAF8F5]">
      ...
      <FeaturedBagsCollections />

      {/* SECTION 3: PRODUCT COLLECTION CONTAINER */}
      <div ref={productGridRef} className="max-w-[1600px] mx-auto px-6 lg:px-12 xl:px-16 py-12">
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-start">
          ...
          {/* RIGHT: THREE-COLUMN PRODUCT GRID */}
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="bg-[#FFFDFC] border border-[#E5D8C8] rounded-2xl p-12 text-center my-6 flex flex-col items-center">
                ...
                <h3 className="font-serif text-2xl text-[#3B2618] font-normal mb-2">
                  No Leather Bags Match Selected Filters
                </h3>
                <p className="text-[#6B6258] text-sm max-w-md mb-6">
                  Try adjusting your price range, collection preference, or category filters to explore all bags.
                </p>
                <button
      ...
      {/* SECTION 5: RELATED COLLECTIONS */}
      <RelatedBagsCollections />
